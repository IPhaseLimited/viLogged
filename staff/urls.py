...
urlpatterns = patterns('',
    ...
    url(r'^modal-add/$', StaffFormView.as_view(), name='staff_modal_form'),
    url(r'^edit/(?P<pk>\d+)$', StaffFormView.as_view(), name='staff_edit_pk'),
    url(r'^modal-edit/(?P<pk>\d+)$', StaffFormView.as_view(), name='staff_modal_edit_pk'),
    url(r'^modal-edit/(?P<pk>\d+)$', StaffFormView.as_view(), name='staff_modal_edit'),
